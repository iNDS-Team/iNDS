...
static UIImage *iconInternalCheat = nil;
static UIImage *iconActionReplay = nil;
static UIImage *iconCodeBreaker = nil;
...
- (id) initWithCheatData:(CHEATS_LIST *)cheatData
{
	...
	{
		iconInternalCheat = [[UIImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"AppIcon_DeSmuME" ofType:@"icns"]];
		iconActionReplay = [[UIImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"Icon_ActionReplay_128x128" ofType:@"png"]];
		iconCodeBreaker = [[UIImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"Icon_CodeBreaker_128x128" ofType:@"png"]];
	}
...
- (void) setCheatTypeIcon:(UIImage *)theIcon
{
	// Do nothing. This method exists for KVO compliance only.
}

- (UIImage *) cheatTypeIcon
{
	UIImage *theIcon = nil;
...
{
	//pthread_mutex_lock(self.cdsCore.mutexCoreExecute);
	NSUInteger activeCheatsCount = 0;//self.listData->getActiveCount();
	//pthread_mutex_unlock(self.cdsCore.mutexCoreExecute);
